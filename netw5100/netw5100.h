 ...
 *  each of the sockets.
 */
#define  SKT_CLOSED			0x00		/* closed */
//#define  SKT_INIT			0x13		/* init state */
//#define  SKT_LISTEN			0x14		/* listen state */
//#define  SKT_SYNSENT			0x15		/* connection state */
//#define  SKT_SYNRECV			0x16		/* connection state */
#define  SKT_ESTABLISHED		0x17		/* success to connect */
#define  SKT_FIN_WAIT		0x18		/* closing state */
#define  SKT_CLOSING			0x1A		/* closing state */
#define  SKT_TIME_WAIT		0x1B		/* closing state */
#define  SKT_CLOSE_WAIT		0x1C		/* closing state */
#define  SKT_LAST_ACK		0x1D		/* closing state */
//#define  SKT_UDP				0x22		/* UDP socket */
//#define  SKT_IPRAW			0x32		/* IP raw mode socket */
//#define  SKT_MACRAW			0x42		/* MAC raw mode socket */
//#define  SKT_PPPOE			0x5F		/* PPPOE socket */


//typedef W5100_CFG NET_CFG;
/*
 *  The W5100_CFG structure holds the target-specific MAC, IP, and gateway addresses,
 *  as well as the subnet mask.
 */
...
unsigned char		OpenClientSocket(unsigned char  sock, unsigned char  eth_protocol, unsigned int  tcp_port);
void					CloseSocket(unsigned char  sock);
void					DisconnectSocket(unsigned char  sock);
unsigned char		Listen(unsigned char  sock);
unsigned char		Connect(unsigned char  sock, unsigned char* daddr, unsigned int dtcp_port);
...
/*
 *  Generic status codes, not associated with the real device.
 */
